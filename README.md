...
1. How would you describe acessibility on the web to someone new to programming?
  Accesibilty is having people friendly websites that are seamless to navigate and ensuring they are as well for people with physical impairments.

2. Talk about 3 different things you can do to ensure your website is accessible. 
  1) Have HTML being written as semantic as possible so that people and screen readers can easily read. 
  2) Use appropiate headers so that search engines can find the contents of your web page. They also provide structure to a webpage by showing portions of the webpage depending on their header. For example: h1 tags tell the user what the page is about, h2 tags tell the user this is a subsection of what the page entire page is about.
  3) Have the website be navigable by having easy to click buttons (having padding on the content) and links with names (as opposed to just 'link') for people to understand.
